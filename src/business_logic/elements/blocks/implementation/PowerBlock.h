#ifndef BUSINESS_LOGIC_ELEMENTS_IMPL_POWER_BLOCK_H
#define BUSINESS_LOGIC_ELEMENTS_IMPL_POWER_BLOCK_H
...
namespace business_logic::elements::blocks {
     ...
     */
    class PowerBlock final : public business_logic::Loggable<PowerBlock>,
       ...
       protected:
        ...
        business_logic::elements::blocks::BlockType getBlockType() const override {
            return business_logic::elements::blocks::BlockType::Power;
        }
...
#endif  // BUSINESS_LOGIC_ELEMENTS_IMPL_POWER_BLOCK_H
